...
class CodebaseManagerPanel(QtWidgets.QWidget):
    ...
    def _create_basic_tab(self) -> QtWidgets.QWidget:
        ...
        self._reliability_slider = QtWidgets.QSlider(Qt.Orientation.Horizontal)
    ...
    def _populate_tree(self) -> None:
        ...
        for module in self._modules:
            ...
            item.setData(0, Qt.ItemDataRole.UserRole, module)
    ...
    def _filter_modules(self, query: str) -> None:
        ...
        for i in range(self._tree.topLevelItemCount()):
            ...
            for j in range(category_item.childCount()):
                ...
                module: CodebaseModule = item.data(0, Qt.ItemDataRole.UserRole)
    ...
    def _emit_module_selection(self) -> None:
        ...
        if not selected_items:
            return
        module = selected_items[0].data(0, Qt.ItemDataRole.UserRole)
        if module:
