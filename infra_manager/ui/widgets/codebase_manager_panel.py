...
class CodebaseManagerPanel(QtWidgets.QWidget):
    ...
    moduleSelected = QtCore.Signal(CodebaseModule)
    profileSaved = QtCore.Signal(CodebaseProfile)
    ...
    def _create_basic_tab(self) -> QtWidgets.QWidget:
        ...
        self._reliability_slider = QtWidgets.QSlider(QtCore.Qt.Horizontal)
    ...
    def _filter_modules(self, query: str) -> None:
        ...
        for i in range(self._tree.topLevelItemCount()):
            ...
            for j in range(category_item.childCount()):
                ...
                module: CodebaseModule = item.data(0, QtCore.Qt.UserRole)
    ...
    def _emit_module_selection(self) -> None:
        ...
        if not selected_items:
            return
        module = selected_items[0].data(0, QtCore.Qt.UserRole)
        if module:
