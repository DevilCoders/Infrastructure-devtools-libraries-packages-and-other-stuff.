...
class Theme:
    ...
    def palette(self) -> QtGui.QPalette:
        ...
        palette.setColor(
            QtGui.QPalette.ColorRole.AlternateBase, QtGui.QColor(self.card_color)
        )
        palette.setColor(
            QtGui.QPalette.ColorRole.ToolTipBase, QtGui.QColor(self.card_color)
        )
        palette.setColor(
            QtGui.QPalette.ColorRole.ToolTipText, QtGui.QColor(self.text_color)
        )
        ...
        palette.setColor(
            QtGui.QPalette.ColorRole.ButtonText, QtGui.QColor(self.text_color)
        )
        palette.setColor(
            QtGui.QPalette.ColorRole.Highlight, QtGui.QColor(self.accent_color)
        )
        palette.setColor(
            QtGui.QPalette.ColorRole.HighlightedText, QtGui.QColor("white")
        )
        return palette
