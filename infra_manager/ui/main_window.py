...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _create_central_widget(self) -> None:
        ...
        central.setObjectName("frostedContainer")
    ...
    def _create_overview_tab(self) -> QtWidgets.QWidget:
        ...
        intro.setHtml(
            """
            <h2 style='font-size:32px; font-weight:700; letter-spacing:0.05em; color:#FF0040;'>
                Infrastructure Command Studio
            </h2>
            <p style='font-size:16px; color:rgba(255,255,255,0.65); line-height:1.6;'>
                Command an end-to-end platform cockpit engineered for DevOps, platform
                engineering, and AI enablement squads. The luminescent navigation up top
                lets you pivot between delivery pipelines, governance overlays, runtime
                observability, and AI augmented operations in a single sweep.
            </p>
            <p style='font-size:15px; color:rgba(255,255,255,0.7); line-height:1.6;'>
                Drop in bespoke playbooks via <b>Configurations</b>, orchestrate governed
                deploys from <b>Local Deploy</b>, or accelerate incident handling with
                <b>AI Assistants</b>. Every surface is tuned for rich telemetry and
                aesthetic focus so stakeholders always operate in clarity.
            </p>
            """
        )
    ...
    def _create_advanced_features_tab(self) -> QtWidgets.QWidget:
        return AdvancedFeaturePanel(self.state.advanced_features, self.state.infrastructures)
